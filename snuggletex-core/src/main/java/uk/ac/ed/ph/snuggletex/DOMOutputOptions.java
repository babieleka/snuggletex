...
public class DOMOutputOptions implements Cloneable {
    ...
    public static enum ErrorOutputOptions {
        ...
        /**
         * Each error is marked up as an XHTML <code>div</code> element associated to the <code>error</code>
         * CSS class.
         * <p>
         * Errors occurring inside MathML expressions will be represented by a <code>merror</code>
    ...
    /** 
     * Set to true to inline CSS styling (i.e. uses <code>style</code> attributes). This is useful
     ...
     * "stylings" like <code>\\mathcal</code> and <code>\\mathbb</code>. Doing this can help if you
    ...
    /**
     * Get whether CSS styling is being inlined via <code>style</code> attributes or not.
    ...
    /**
     * Set whether CSS styling is to be inlined via <code>style</code> attributes or not.
     * This is useful if your output is going to end up embedded in someone else's page
    ...
    /** 
     * Returns whether the MathML <code>math</code> elements generated by SnuggleTeX should
    ...
    /** 
     * Sets whether the MathML <code>math</code> elements generated by SnuggleTeX should
     ...
     * effectively ignore any <code>display="block"</code> attribute on the enclosing MathML
     * element.
     * <p>

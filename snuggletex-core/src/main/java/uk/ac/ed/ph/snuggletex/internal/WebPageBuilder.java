...
public final class WebPageBuilder {
     ...
     * @param contentTypeSettable optional bean Object that will have its <code>contentType</code>
     *   property set if provided. (This is generally useful as a proxy for the <code>HttpResponse</code>
    ...
    /**
     * Calls the <code>setContentType</code> method for the given Object (by reflection) to something
     ...
     * 
     * @param contentTypeSettable Object that will have its <code>contentType</code>
     ...
     * as an the XHTML <code>meta</code> element.
     * 

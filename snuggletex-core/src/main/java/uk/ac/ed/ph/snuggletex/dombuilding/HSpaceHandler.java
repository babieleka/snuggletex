...
/**
 * Handles the <code>\\hspace</code> and <code>\\hspace*</code> commands.
 * <p>
 * Note that we are going to handle <code>\\hspace*</code> in exactly the same way
 * as <code>\\hspace</code> since it is not easy to detect when we are at the end of
 * a line.
 * 
 * @author David McKain
 * @version $Revision$
